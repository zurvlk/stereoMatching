*****************************************************************************************************
	3種類の画像に対してα-拡張アルゴリズムでステレオ対応問題を解くためのプログラムを実行するシェルスクリプト
*****************************************************************************************************
compile: make
run: ./run.sh
...
outputフォルダに出力画像 (a-exp_*_d_v_l_t.bmp)が保存される
...
*****************************************************************************************************
	α-拡張アルゴリズムでステレオ対応問題を解くためのプログラム
*****************************************************************************************************
...
コンパイル・実行例　---画像: tsukuba λ=2 T=8 初期ラベル5 データ項がBirchfield and Tomasi’s function  平滑化項が2乗関数, Carr and Hartley の α-拡張をを用いるとき---
compile: make
run: ./a-estr ../input/tsukuba output.bmp 16 2 8 0 0 5 0
